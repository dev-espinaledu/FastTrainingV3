            ...
            <section className=" w-full h-full flex flex-col">
                ...
                <main className="w-full h-[90vh] pl-16 rounded-md bg-white overflow-y-scroll">
                    ...
                    <section className='grid grid-cols-2 w-full'>
                        <div className="flex gap-4 my-3 justify-left items-center">
                            <figure className='h-28'>
                                <img className="h-full" src="/img/circular-stat-blue.png" alt="" />
                            </figure>
                        ...
                        <div className="flex gap-4 my-3 justify-left items-center">
                            <figure className='h-28'>
                                <img className="h-full" src="/img/circular-stat-pink.png" alt="" />
                            </figure>
                        ...
                        <div className="flex gap-4 my-3 justify-left items-center">
                            <figure className='h-28'>
                                <img className="h-full" src="/img/circular-stat-yellow.png" alt="" />
                            </figure>
                        ...
                        <div className="flex gap-4 my-3 justify-left items-center">
                            <figure className='h-28'>
                                <img className="h-full" src="/img/circular-stat-green.png" alt="" />
                            </figure>
                    ...
                    <section className="w-full my-4">
                        <img src="/img/mesociclo5-1.png" alt="" />
                    </section>
                </main>
            </section>
        </div>
