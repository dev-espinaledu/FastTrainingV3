            ...
            <nav className="flex flex-col justify-between items-center w-full rounded bg-slate-50 group-hover:items-baseline group-hover:pl-4">
                <ul className="flex gap-2 flex-col justify-center py-2">
                    ...
                    <li className="w-full h-fit list-none">
                        <Link href={"/player/home"} className="hover:bg-neutral-300 text-center flex justify-center items-center w-12 h-12 group-hover:w-full gap-4 group-hover:justify-start rounded"><HomeIcon />
                    ...
                    <li className="w-fit h-fit" >
                        <Link href={"/player/documents"} className="flex hover:bg-neutral-300 justify-center items-center w-12 h-12 group-hover:w-full rounded gap-4">
                            <FolderIcon />
                    ...
                    {/* Configuracion */}
                    <li className="w-fit h-fit" >
                        <Link href={"/player/config"} className="flex hover:bg-neutral-300 justify-center items-center w-12 h-12 group-hover:w-full rounded gap-4" >
                            <ConfigIcon />
                ...
                <ul className="flex gap-2 flex-col py-2">
                    ...
                    <li className="w-fit h-fit" >
                        <Link href={"/player/help"} className="flex hover:bg-neutral-300 justify-center items-center w-12 h-12 group-hover:w-full rounded gap-4" >
                            <HelpIcon />
