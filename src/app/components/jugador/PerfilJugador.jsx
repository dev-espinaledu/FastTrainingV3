function IconPerfil() {
  ...
  function IconPlayer() {
    return (
        <img className="h-16 w-15"  src="/public/player-icon.png" alt="personal-trainer"/>
    )
  }
  ...
  function Nombre() {
    return (
      <div className="mb-9 flex flex-col items-start ">
        ...
        <p className="font-light text-1xl">Alexander Ramos</p>
      </div>
    ...
    return (
      <div className="mb-9 flex flex-col items-start">
        ...
        <div className="flex font-light">
          <p className="text-1xl">al3xr4mos@gmail.com</p>
          <IconPencil />
        </div>
      </div>
    );
    ...
    return (
      <div className="mb-9 flex flex-col items-start">
        ...
        <div className="flex flex-col items-center w-fit font-light">
          <IconPlayer />
          <p className="text-1xl">Jugador</p>
        </div>
      </div>
